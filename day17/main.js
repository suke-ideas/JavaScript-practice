// Exercises day 17: 6/6/2022 : web storages
...
let fName = 'Bùi Thị Thanh'
let lName = "Ngân"
let age = 19
let birthday = '22/05/2003'
let country = 'Việt Nam'
let city = 'Quảng Ngãi'

localStorage.setItem('Họ tên',`${fName} ${lName}`);
localStorage.setItem('Tuổi',age);
localStorage.setItem('Ngày sinh',birthday);
localStorage.setItem('Quê quán',`${city} - ${country}`)
...
let student = {
    ...
    skills: ['ăn','ngủ','học','nghe nhạc','viết lách','code','buồn']
}

let objStudent = JSON.stringify(student);
localStorage.setItem('Thông tin:',objStudent);
console.log(localStorage)
